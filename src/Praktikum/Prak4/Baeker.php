...
class Baeker extends Page
{
    ...
    HTML;
            ...
            <form id="formid$special_ordered_article_id" action="Baeker.php" method="post">
                ...
                <input type="hidden" name="ordered_article_id" value="{$special_ordered_article_id}">
            </form>
    ...
    protected function processReceivedData(): void
    {
        ...
        if (isset($_POST['ordering_id']) && isset($_POST['ordered_article_id']) && isset($_POST['order_status_' . $_POST['ordered_article_id']])) {
            ...
            $status = $this->_database->real_escape_string($_POST['order_status_' . $ordered_article_id]);
